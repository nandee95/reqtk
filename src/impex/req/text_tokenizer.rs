...
impl TextTokenizer {
    ...
    pub fn tokenize<R: Read>(reader: &mut R) -> Result<Vec<Token>, IoError> {
        ...
        loop {
            ...
            tokenizer.follower = token.value.follower(&tokenizer.result).unwrap_or_default();
        }
        ...
        loop {
            if let Some(ch) = iter.next().transpose()? {
                        ...
                        || self.follower.terminator.contains(&token))
                {
                    ...
                    self.cursor = self.cursor.advance_by(0, 1);
                    self.result.push(Token::from_source(
                        token,
    ...
    fn test_tokenize_non_token_string() {
        ...
        assert_eq!(
            ...
            vec![Token::from_value(
                ...
                Span::new(Cursor::new(1, 1), Cursor::new(1, 4))
            )]
        );
    }
    #[test]
        ...
        assert_eq!(
            ...
            vec![
                ...
                Token::from_value(
                    ...
                    Span::new(Cursor::new(1, 4), Cursor::new(1, 5))
                )
            ]
        );
    }
    ...
    fn test_tokenize_end_with_non_token_characters() {
        ...
        assert_eq!(
            ...
            vec![
                Token::from_value(
                    TokenValue::TitleEnd,
                    Span::new(Cursor::new(1, 1), Cursor::new(1, 2))
                ),
                Token::from_value(
                    TokenValue::RawString("asd".into()),
                    Span::new(Cursor::new(1, 2), Cursor::new(1, 5))
                ),
            ]
        );
    }
    ...
    fn test_tokenize_utf8_characters() {
        ...
        assert_eq!(
            ...
            vec![Token::from_value(
                ...
                Span::new(Cursor::new(1, 1), Cursor::new(1, 6))
            ),]
        );
    }
        ...
        assert_vec_eq!(
            ...
            vec![
                ...
                Token::from_value(
                    ...
                    Span::new(Cursor::new(1, 2), Cursor::new(1, 11))
                ),
                Token::from_value(
                    TokenValue::AttributeSeparator,
                    Span::new(Cursor::new(1, 11), Cursor::new(1, 12))
                ),
                Token::from_value(
                    TokenValue::AttributeValue("value".into()),
                    Span::new(Cursor::new(1, 12), Cursor::new(1, 17))
                ),
                Token::from_value(
                    TokenValue::AttributeEnd,
                    Span::new(Cursor::new(1, 17), Cursor::new(1, 18))
                ),
            ]
        );
    }
        ...
        assert_vec_eq!(
            ...
            vec![
                ...
                Token::from_value(
                    ...
                    Span::new(Cursor::new(1, 2), Cursor::new(1, 4))
                ),
                Token::from_value(
                ...
                Token::from_value(
                    ...
                    Span::new(Cursor::new(1, 5), Cursor::new(1, 10))
                ),
                Token::from_value(
                    TokenValue::TitleEnd,
                    Span::new(Cursor::new(1, 10), Cursor::new(1, 11))
                ),
                Token::from_value(
                ...
                Token::from_value(
                    TokenValue::AttributeStart,
                    Span::new(Cursor::new(1, 12), Cursor::new(1, 13))
                ),
                Token::from_value(
                    TokenValue::AttributeKey("description".into()),
                    Span::new(Cursor::new(1, 13), Cursor::new(1, 24))
                ),
                Token::from_value(
                    TokenValue::AttributeSeparator,
                    Span::new(Cursor::new(1, 24), Cursor::new(1, 25))
                ),
                Token::from_value(
                    TokenValue::AttributeValue("Hello world".into()),
                    Span::new(Cursor::new(1, 25), Cursor::new(1, 36))
                ),
                Token::from_value(
                    TokenValue::AttributeEnd,
                    Span::new(Cursor::new(1, 36), Cursor::new(1, 37))
                ),
                Token::from_value(
                    TokenValue::BodyEnd,
                    Span::new(Cursor::new(1, 37), Cursor::new(1, 38))
                ),
            ]
        );
    }
    ...
    fn test_tokenize_requirement_empty_title() {
        ...
        assert_vec_eq!(
            ...
            vec![
                ...
                Token::from_value(
                    TokenValue::TitleEnd,
                    Span::new(Cursor::new(1, 5), Cursor::new(1, 6))
                ),
                Token::from_value(
                    TokenValue::BodyStart,
                    Span::new(Cursor::new(1, 6), Cursor::new(1, 7))
                ),
                Token::from_value(
                    TokenValue::AttributeStart,
                    Span::new(Cursor::new(1, 7), Cursor::new(1, 8))
                ),
                Token::from_value(
                    TokenValue::AttributeKey("description".into()),
                    Span::new(Cursor::new(1, 8), Cursor::new(1, 19))
                ),
                Token::from_value(
                    TokenValue::AttributeSeparator,
                    Span::new(Cursor::new(1, 19), Cursor::new(1, 20))
                ),
                Token::from_value(
                    TokenValue::AttributeValue("Hello world".into()),
                    Span::new(Cursor::new(1, 20), Cursor::new(1, 31))
                ),
                Token::from_value(
                    TokenValue::AttributeEnd,
                    Span::new(Cursor::new(1, 31), Cursor::new(1, 32))
                ),
                Token::from_value(
                    TokenValue::BodyEnd,
                    Span::new(Cursor::new(1, 32), Cursor::new(1, 33))
                ),
            ]
        );
    }
        ...
        assert_vec_eq!(
            ...
            vec![
                ...
                Token::from_value(
                    ...
                    Span::new(Cursor::new(1, 2), Cursor::new(1, 8))
                ),
                Token::from_value(
                    TokenValue::TitleStart,
                    Span::new(Cursor::new(1, 8), Cursor::new(1, 9))
                ),
                Token::from_value(
                    TokenValue::Title("Custom".into()),
                    Span::new(Cursor::new(1, 9), Cursor::new(1, 15))
                ),
                Token::from_value(
                    TokenValue::TitleEnd,
                    Span::new(Cursor::new(1, 15), Cursor::new(1, 16))
                ),
                Token::from_value(
                    TokenValue::BodyStart,
                    Span::new(Cursor::new(1, 16), Cursor::new(1, 17))
                ),
                Token::from_value(
                    TokenValue::AttributeStart,
                    Span::new(Cursor::new(1, 17), Cursor::new(1, 18))
                ...
                Token::from_value(
                    ...
                    Span::new(Cursor::new(1, 18), Cursor::new(1, 22))
                ),
                Token::from_value(
                    TokenValue::AttributeSeparator,
                    Span::new(Cursor::new(1, 22), Cursor::new(1, 23))
                ),
                Token::from_value(
                    TokenValue::AttributeValue("build".into()),
                    Span::new(Cursor::new(1, 23), Cursor::new(1, 28))
                ),
                Token::from_value(
                    TokenValue::AttributeEnd,
                    Span::new(Cursor::new(1, 28), Cursor::new(1, 29))
                ),
                Token::from_value(
                    TokenValue::BodyEnd,
                    Span::new(Cursor::new(1, 29), Cursor::new(1, 30))
                ),
            ]
        );
    }
