...
impl Spanned<String> {
    ...
    pub fn is_exact(&self) -> bool {
        self.span.start.advance(&self.value) == self.span.end
    }
    ...
    pub fn combine(&self, other: &Spanned<String>) -> Spanned<String> {
        format!("{}{}", self.value, other.value)
            .into_spanned(Span::new(self.span.start, other.span.end))
    }
}
...
mod tests {
    ...
    fn test_spanned_string_no_leading_trailing_whitespaces() {
        let input = "hello"
            .to_string()
            .into_spanned(Span::new(Cursor::new(11, 5), Cursor::new(11, 10)));
    ...
    fn test_spanned_string_leading_trailing_non_newline_whitespaces() {
        ...
        assert_eq!(
            trimmed.span,
            Span::new(Cursor::new(11, 7), Cursor::new(11, 12))
        );
    ...
    fn test_spanned_string_leading_trailing_newline_whitespaces() {
        ...
        let input = input_str
            .to_string()
            .into_spanned(Span::new(Cursor::new(11, 12), Cursor::new(15, 1)));

        let trimmed = input.trim();
        assert_eq!(trimmed.value, "hello");
        assert_eq!(
            trimmed.span,
            Span::new(Cursor::new(13, 3), Cursor::new(13, 8))
        );
    ...
    fn test_spanned_string_with_indentation() {
        ...
        let input = input_str
            .to_string()
            .into_spanned(Span::new(Cursor::new(11, 1), Cursor::new(17, 1)));

        let trimmed = input.trim();
        assert_eq!(trimmed.value, "hello\n\t\t\tworld\n\t\t\tthere");
        assert_eq!(
            trimmed.span,
            Span::new(Cursor::new(13, 4), Cursor::new(15, 9))
        );
